...
class bacula::director {
    ...
    if hiera('base::monitoring::use_icinga2', false) {
        ...
        icinga2::custom::services { 'Bacula Misc4 Lizardfs':
            check_command => 'nrpe',
            vars          => {
        ...
        icinga2::custom::services { 'Bacula Lizardfs Lizardfs':
            check_command => 'nrpe',
            vars          => {
                nrpe_command => 'check_bacula_lizardfs_lizardfs',
            },
        }

        icinga2::custom::services { 'Bacula Lizardfs2 Lizardfs':
            check_command => 'nrpe',
            vars          => {
                nrpe_command => 'check_bacula_lizardfs2_lizardfs',
            },
        }
        ...
        icinga::service { 'bacula_misc4_lizardfs':
            description   => 'Bacula - /var/lib/lizardfs misc4',
            check_command => 'check_nrpe_1arg!check_bacula_misc4_lizardfs',
        }

        icinga::service { 'bacula_lizardfs_lizardfs':
            description   => 'Bacula - /var/lib/lizardfs lizardfs',
            check_command => 'check_nrpe_1arg!check_bacula_lizardfs_lizardfs',
        }

        icinga::service { 'bacula_lizardfs_lizardfs2':
            description   => 'Bacula - /var/lib/lizardfs lizardfs2',
            check_command => 'check_nrpe_1arg!check_bacula_lizardfs_lizardfs2',
        }
