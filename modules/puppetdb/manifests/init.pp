...
class puppetdb(
    ...
    $prometheus_java_opts = "-javaagent:/usr/share/java/prometheus/jmx_prometheus_javaagent.jar=${::fqdn}:9400:/etc/puppetlabs/puppetdb/jvm_prometheus_puppetdb_jmx_exporter.yaml"
