# mediawiki::php
class mediawiki::php (
    $php_fpm_childs = lookup('mediawiki::php::fpm::childs', 18),
    $fpm_min_restart_threshold = lookup('mediawiki::php::fpm::fpm_min_restart_threshold', 6),
    $php_version = lookup('php::php_version', '7.2'),
