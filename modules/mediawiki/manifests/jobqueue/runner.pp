...
class mediawiki::jobqueue::runner (
    ...
    if lookup('mediawiki::jobqueue::runner::cron', {'default_value' => false}) {
        ...
        cron { 'managewikis':
            ...
            command => "/usr/bin/php ${runner}/srv/mediawiki/${version}/extensions/CreateWiki/maintenance/manageInactiveWikisV2.php --wiki ${wiki} --write >> /var/log/mediawiki/cron/managewikis.log",
            user    => 'www-data',
            minute  => '5',
            hour    => '12',
        }
