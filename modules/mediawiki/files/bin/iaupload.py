...
class ArchiveUploader:
    def __init__(self):
        ...
        self.parser.add_argument(
            '--proxy', dest='proxy', default='http://bastion.fsslc.wtnet:8080',
            help='The proxy to use for requests to archive.org. Optional. Default: http://bastion.fsslc.wtnet:8080')
