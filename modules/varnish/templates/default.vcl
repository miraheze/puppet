		...
		<div class="container">
			<div class="body-content">
				<div class="row">
					...
					<div class="col-md-6">
						<a class="twitter-timeline" href="https://twitter.com/MirahezeStatus?ref_src=twsrc%5Etfw">Tweets by MirahezeStatus</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
					</div>
				</div>
			</div>
		</div>
