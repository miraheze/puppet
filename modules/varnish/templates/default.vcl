...
sub vcl_deliver {
	...
	set resp.http.Content-Security-Policy = "default-src 'self' data: <%- @whitelist.each_pair do |config, value| -%> <%= value %> <%- end -%> 'unsafe-inline' 'unsafe-eval'; object-src 'self' blob";
}
