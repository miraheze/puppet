class profile::icinga2::main (
    ...
    String $icinga2_db_password             = hiera('passwords::icinga_ido'),
    ...
    String $icingaweb2_ido_db_user_password = hiera('passwords::icinga_ido'),
    ...
    class { '::monitoring':
        ...
        db_password           => $icinga2_db_password,
    ...
    class { '::icingaweb2':
        ...
        ido_db_user_password  => $icingaweb2_ido_db_user_password,
