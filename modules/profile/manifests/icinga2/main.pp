class profile::icinga2::main (
    String $icinga2_db_host                 = lookup('icinga_ido_db_host', {'default_value' => 'db6.miraheze.org'}),
    ...
    String $icingaweb2_ido_db_host          = lookup('icinga_ido_db_host', {'default_value' => 'db6.miraheze.org'}),
