class profile::icinga2::main (
    String $icinga2_db_host                 = hiera('icinga_ido_db_host', 'db7.miraheze.org'),
    ...
    String $icingaweb2_db_host              = hiera('icingaweb_db_host', 'db7.miraheze.org'),
    ...
    String $icingaweb2_ido_db_host          = hiera('icinga_ido_db_host', 'db7.miraheze.org'),
