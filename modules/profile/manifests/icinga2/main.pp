class profile::icinga2::main (
    String $icinga2_db_host                 = hiera('icinga_ido_db_host', {'default_value' => 'db7.miraheze.org'}),
    String $icinga2_db_name                 = hiera('icinga_ido_db_name', {'default_value' => 'icinga'}),
    String $icinga2_db_user                 = hiera('icinga_ido_user_name', {'default_value' =>'icinga2'}),
    String $ido_db_user_password            = hiera('passwords::icinga_ido'),
    String $mirahezebots_password           = hiera('passwords::irc::mirahezebots'),
    String $icingaweb2_db_host              = hiera('icingaweb_db_host', {'default_value' =>'db7.miraheze.org'}),
    String $icingaweb2_db_name              = hiera('icingaweb_db_name', {'default_value' =>'icingaweb2'}),
    String $icingaweb2_db_user_name         = hiera('icingaweb_user_name', {'default_value' =>'icingaweb2'}),
    String $icingaweb2_db_user_password     = hiera('passwords::icingaweb2'),
    String $icingaweb2_ido_db_host          = hiera('icinga_ido_db_host', {'default_value' =>'db7.miraheze.org'}),
    String $icingaweb2_ido_db_name          = hiera('icinga_ido_db_name', {'default_value' =>'icinga'}),
    String $icingaweb2_ido_db_user_name     = hiera('icinga_ido_user_name', {'default_value' =>'icinga2'}),
