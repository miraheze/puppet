...
local jobs = { '*', 'CreateWikiJob', 'RequestWikiAIJob', 'RemovePIIJob', 'DataDumpGenerateJob', 'MWScriptJob', 'NamespaceMigrationJob', 'LocalRenameUserJob', 'LocalGlobalUserPageCacheUpdateJob', 'TransformWebPImageJob', 'replaceText', 'webVideoTranscode', 'refreshLinks', 'htmlCacheUpdate', 'recentChangesUpdate' }
