...
class matomo {
    ...
    cron { 'archive_matomo':
        ...
        command => '/usr/local/bin/fileLockScript.sh /tmp/matomo_file_lock "/usr/bin/nice -19 /usr/bin/php /srv/matomo/console core:archive --url=https://matomo.miraheze.org/ --concurrent-requests-per-website=10" > /srv/matomo-archive.log',
        user    => 'www-data',
        minute  => '30',
        hour    => '*/24',
    }
