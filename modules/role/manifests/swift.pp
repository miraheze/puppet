...
class role::swift (
    ...
    $firewall_rules_str = join(
        query_facts('Class[Role::Swift] or Class[Role::Mediawiki] or Class[Role::Mediawiki_beta] or Class[Role::Icinga2] or Class[Role::Prometheus] or Class[Role::Bastion] or Class[Role::Varnish]', ['networking'])
        .map |$key, $value| {
