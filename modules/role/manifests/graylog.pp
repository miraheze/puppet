...
class role::graylog {
    ...
    # non-OpenVZ (RamNode)
    $fwSyslog = query_facts("domain='$domain' and Class[Base] and network_venet0!='127.0.0.1'", ['ipaddress', 'ipaddress6'])
    ...
    $fwSyslogVenet = query_facts("domain='$domain' and Class[Base] and network_venet0='127.0.0.1'", ['ipaddress_venet0:0', 'ipaddress6_venet0'])
