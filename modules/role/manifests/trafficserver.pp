...
class role::trafficserver (
    ...
    Array $req_handling                                         = lookup('role::trafficserver::cache::req_handling'),
    Array $alternate_domains                                    = lookup('role::trafficserver::cache::alternate_domains', {'default_value' => {}}),
