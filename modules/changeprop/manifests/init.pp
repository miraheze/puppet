...
class changeprop (
    ...
    $import_host                    = lookup('changeprop::import_host', {'default_value' => 'http://localhost:4063'}),
    $videoscaler_host               = lookup('changeprop::videoscaler_host', {'default_value' => 'http://localhost:4063'}),
    $jobrunner_beta_host            = lookup('changeprop::jobrunner_beta_host', {'default_value' => 'http://localhost:4063'}),
    $import_beta_host               = lookup('changeprop::import_beta_host', {'default_value' => 'http://localhost:4063'}),
    $videoscaler_beta_host          = lookup('changeprop::videoscaler_beta_host', {'default_value' => 'http://localhost:4063'}),
